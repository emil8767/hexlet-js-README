...
<div class="mt-2">{{ Form::password('password', ['class' => 'rounded border-gray-300 w-1/3', 'cols' => '50', 'rows' => '10']) }}<br></div>
...
<div class="mt-2">{{ Form::select('status', ['C' => 'Connected', 'D' => 'Disconnected'], $user->status, ['placeholder' => 'Search status...', 'class' => 'rounded border-gray-300 w-1/3']) }}<br></div>
